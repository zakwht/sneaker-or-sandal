...
def initclf():
    train = clean(mnist_reader.load_mnist(
        'fashionmnist/data/fashion', kind='train'))
    test = clean(mnist_reader.load_mnist(
        'fashionmnist/data/fashion', kind='t10k'))
...
def upload_file():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            url2 = 'data:image/png;base64,' + \
                b64encode(buff.getvalue()).decode()
